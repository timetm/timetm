...
namespace Lookin2\AgendaBundle\Controller;
...
use Lookin2\AgendaBundle\Entity\Agenda;
use Lookin2\AgendaBundle\Form\AgendaType;
...
class AgendaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('Lookin2AgendaBundle:Agenda')->findAll();
     ...
     * @Method("POST")
     * @Template("Lookin2AgendaBundle:Agenda:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('Lookin2AgendaBundle:Agenda')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("Lookin2AgendaBundle:Agenda:edit.html.twig")
     */
